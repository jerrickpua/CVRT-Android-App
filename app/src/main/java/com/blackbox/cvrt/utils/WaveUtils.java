...
public class WaveUtils {
    ...
    public static void parseRawFileToWav( FileInputStream fis, OutputStream outputStream, int sampleRate ) throws IOException {
...
//    private void parseRawFileToWav( File rawAudioFile, File outputFile ) {
//        long totalAudioLen = 0;
//        long totalDataLen = totalAudioLen + 36;
//        long longSampleRate = recorder.getSampleRate();
//        int channels = 2;
//        long byteRate = RECORDER_BPP * recorder.getSampleRate() * channels / 8;
//        byte[] data = new byte[ recorder.getBufferSize() ];
//        try ( FileInputStream fis = new FileInputStream( rawAudioFile ); FileOutputStream fos = new FileOutputStream( outputFile ) ) {
